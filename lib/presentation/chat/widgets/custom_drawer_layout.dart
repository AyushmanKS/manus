...
class _CustomDrawerLayoutState extends ConsumerState<CustomDrawerLayout>
  ...
  void _onHorizontalDragUpdate(final DragUpdateDetails details, final double width) {
    if (!_canDrag) return;
  ...
  void _onHorizontalDragEnd(final DragEndDetails details, final double width) {
    ...
    final double velocity = details.primaryVelocity! / (width * _drawerWidthFactor);
      ...
      children: <Widget>[
        ...
        AnimatedBuilder(
          ...
          builder: (final BuildContext context, final Widget? child) {
            return Transform.translate(
              offset: Offset(-drawerWidth + (_controller.value * drawerWidth), 0),
              child: SizedBox(
                width: drawerWidth,
                child: widget.drawer,
              ),
        ...
        Positioned.fill(
          child: GestureDetector(
            ...
            onHorizontalDragUpdate: (final DragUpdateDetails d) => _onHorizontalDragUpdate(d, width),
            onHorizontalDragEnd: (final DragEndDetails d) => _onHorizontalDragEnd(d, width),
